...
class UserProfile(models.Model):
    ...
    gender=models.BooleanField(_("gender"),null=True,help_text="if male is True , if female is False and null is unset")
...
class Device(models.Model):
    ...
    last_login=models.DateTimeField(_("last time login"),null=True)
